...
if st.button("Predict Star Type"):
    ...
    star_name = STAR_TYPES.get(result, "Unknown")
    
    st.success(f"Predicted Star Type: **{star_name}** (Type {result})")
...
st.markdown(
    ...
    <div class='footer-card' style='text-align: center;'>
        <p style='font-size: 16px; margin-bottom: 15px; color: #e0e0e0;'>Created by <strong>Obama</strong></p>
        <div style='display: flex; justify-content: center; gap: 25px;'>
            <a href='https://www.instagram.com/satriabam_/' target='_blank' style='text-decoration: none;'>
            ...
            <a href='https://github.com/Sar-B156' target='_blank' style='text-decoration: none;'>
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href='https://wa.me/628988610455' target='_blank' style='text-decoration: none;'>
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
